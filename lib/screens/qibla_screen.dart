  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('اتجاه القبلة', style: TextStyle(color: Color(0xFFD4AF37))),
        centerTitle: true,
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('المسافة إلى الكعبة: ${_distance.toStringAsFixed(0)} كم', style: const TextStyle(color: Colors.white70, fontSize: 16)),
            ...
            const SizedBox(height: 30),
            Text('زاوية القبلة: ${_qiblaBearing.toStringAsFixed(1)}°', style: const TextStyle(color: Color(0xFFD4AF37), fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            const Text('موقعك: دبي، الإمارات', style: TextStyle(color: Colors.white54, fontSize: 14)),
          ],
        ),
      ),
    );
